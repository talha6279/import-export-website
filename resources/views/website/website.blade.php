                        ...
                        <div class="row align-items-center">
                           <div class="col-xl-5 col-lg-6 col-md-6">
                              <div class="tp-slider-content p-relative z-index-1">
                                 <span><b></b></span>
                                 <h3 class="tp-slider-title">The Best Gymwear Collection</h3>
                                 <p>
                                    <span>
                                 ...
                                 <div class="tp-slider-btn">
                                    <a href="{{route('shop')}}" class="tp-btn tp-btn-2 tp-btn-white">Shop Now
                           ...
                           <div class="col-xl-7 col-lg-6 col-md-6">
                              <div class="tp-slider-thumb text-end">
                                 <img src="{{asset('website/assets/img/slider/slider-img-1.webp')}}" alt="slider-img">
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="container">
                        <div class="row align-items-center">
                           <div class="col-xl-5 col-lg-6 col-md-6">
                              <div class="tp-slider-content p-relative z-index-1">
                                 <span><b></b></span>
                                 <h3 class="tp-slider-title">Bags Collection </h3>
                                 <p>
                                    <span>
                                       <svg width="94" height="20" viewBox="0 0 94 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M74.8576 4.63367L78.6048 5.11367C80.9097 5.35155 82.8309 5.75148 84.4483 5.97993L86.6581 6.31091L88.4262 6.63948C89.4684 6.81761 90.2699 6.9312 90.8805 6.99186C93.3213 7.24888 92.7011 6.63674 92.8183 6.12534C92.9355 5.61394 93.7175 5.37081 91.3267 4.45886C90.73 4.24001 89.9345 3.97481 88.8826 3.65818L87.1034 3.12577L84.8643 2.63282C83.236 2.28025 81.2402 1.82307 78.8684 1.52138L75.0177 0.981633C73.6188 0.823014 72.1417 0.730003 70.5389 0.582533C63.0297 0.0282543 55.4847 0.193022 48.0068 1.07459C39.9065 2.04304 31.9328 3.87384 24.2213 6.53586C18.0824 8.61764 12.1674 11.3089 6.56479 14.5692C4.88189 15.5255 3.25403 16.5756 1.68892 17.7145C0.568976 18.5077 -0.00964231 18.9932 0.0547097 19.0858C0.388606 19.6584 10.6194 13.1924 25.151 8.99361C32.789 6.72748 40.6283 5.20536 48.5593 4.44848C55.8569 3.76455 63.1992 3.69678 70.5082 4.24591L74.8223 4.62335" fill="currentColor"/>
                           ...
                           <div class="col-xl-7 col-lg-6 col-md-6">
                              <div class="tp-slider-thumb text-end">
                                 <img src="{{asset('website/assets/img/slider/slider-img-7.jpg')}}" alt="slider-img">
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="container">
                        <div class="row align-items-center">
                           <div class="col-xl-5 col-lg-6 col-md-6">
                              <div class="tp-slider-content p-relative z-index-1">
                                 <span> <b></b></span>
                                 <h3 class="tp-slider-title">Sportswear Collection</h3>
                                 <p>
                                    <span>
                                       <svg width="94" height="20" viewBox="0 0 94 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M74.8576 4.63367L78.6048 5.11367C80.9097 5.35155 82.8309 5.75148 84.4483 5.97993L86.6581 6.31091L88.4262 6.63948C89.4684 6.81761 90.2699 6.9312 90.8805 6.99186C93.3213 7.24888 92.7011 6.63674 92.8183 6.12534C92.9355 5.61394 93.7175 5.37081 91.3267 4.45886C90.73 4.24001 89.9345 3.97481 88.8826 3.65818L87.1034 3.12577L84.8643 2.63282C83.236 2.28025 81.2402 1.82307 78.8684 1.52138L75.0177 0.981633C73.6188 0.823014 72.1417 0.730003 70.5389 0.582533C63.0297 0.0282543 55.4847 0.193022 48.0068 1.07459C39.9065 2.04304 31.9328 3.87384 24.2213 6.53586C18.0824 8.61764 12.1674 11.3089 6.56479 14.5692C4.88189 15.5255 3.25403 16.5756 1.68892 17.7145C0.568976 18.5077 -0.00964231 18.9932 0.0547097 19.0858C0.388606 19.6584 10.6194 13.1924 25.151 8.99361C32.789 6.72748 40.6283 5.20536 48.5593 4.44848C55.8569 3.76455 63.1992 3.69678 70.5082 4.24591L74.8223 4.62335" fill="currentColor"/>
                           ...
                           <div class="col-xl-7 col-lg-6 col-md-6">
                              <div class="tp-slider-thumb text-end">
                                 <img src="{{asset('website/assets/img/slider/slider-img-5.jpg')}}" alt="slider-img">
                              </div>
                           </div>
                        </div>
                     </div>
         ...
         <div class="col">
            <div class="tp-product-category-item text-center mb-40">
               <div >
                  ...
                  <div id="carousel-{{ $product->item_id }}" class="carousel slide" data-ride="carousel" data-interval="4000">
                        ...
                        @foreach($pictures as $index => $picture)
                           @if ($picture)
                              <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                                <a href="{{route('product-detail', $product->item_id) }}"><img src="{{ asset($picture) }}" width ="150px" height ="150px"  alt="Product Image {{ $index + 1 }}"></a> 
                              </div>
                           @endif
                        @endforeach
                     </div>
                     ...
                     <a class="carousel-control-prev" href="#carousel-{{ $product->item_id }}" role="button" data-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="sr-only">Previous</span>
                     </a>
                     <a class="carousel-control-next" href="#carousel-{{ $product->item_id }}" role="button" data-slide="next">
               ...
               <div class="tp-product-category-content">
                  <h3 class="tp-product-category-title">
                     <a href="{{route('shop-category', $product->slug)}}">{{ $product->itemname }}</a>
                  </h3>
               </div>
            </div>
         </div>
               ...
               <div class="row gx-1 gy-1 gy-xl-0">
                  <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                     <div class="tp-feature-item d-flex align-items-start">
                        ...
                        <div class="tp-feature-content">
                           <h3 class="tp-feature-title">Delivery Period</h3>
                           <p>4 to 8 weeks</p>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                     <div class="tp-feature-item d-flex align-items-start">
                        ...
                        <div class="tp-feature-content">
                           <h3 class="tp-feature-title">Shipment</h3>
                           <p>By air and By sea</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
            ...
            <div class="tp-product-tab tp-product-tab-border mb-45 tp-tab d-flex justify-content-md-end">
               <ul class="nav nav-tabs justify-content-sm-end" id="productTab" role="tablist">
                  <li class="nav-item" role="presentation">
                     <button class="nav-link active" id="gloves-tab" data-bs-toggle="tab" data-bs-target="#gloves-tab-pane" type="button" role="tab" aria-controls="gloves-tab-pane" aria-selected="true">Gymwear</button>
                  </li>
                  <li class="nav-item" role="presentation">
                  ...
                  <li class="nav-item" role="presentation">
                     <button class="nav-link" id="gloves-bags-tab" data-bs-toggle="tab" data-bs-target="#gloves-bags-tab-pane" type="button" role="tab" aria-controls="gloves-bags-tab-pane" aria-selected="false">Sportswear</button>
                  </li>
               </ul>
            </div>
         </div>
         ...
         <div class="col-xl-12">
            <div class="tp-product-tab-content">
               <div class="tab-content" id="myTabContent">
                  ...
                  <!-- Gymwear Products Tab -->
                  <div class="tab-pane fade show active" id="gloves-tab-pane" role="tabpanel" aria-labelledby="gloves-tab">
                     <div class="row">
                        @foreach($gymwear as $product)
                        <div class="col-xl-3 col-lg-3 col-sm-6">
                           <div class="tp-product-item p-relative transition-3 mb-25">
                              <div >
                                 <a href="{{ route('product-detail', $product->item_id) }}">
                                    <img src="{{ asset($product->picture) }}" width="254px" height="270px" alt="{{ $product->itemname }}">
                                 </a>
                  ...
                  <!-- Bags Products Tab -->
                  <div class="tab-pane fade" id="bags-tab-pane" role="tabpanel" aria-labelledby="bags-tab">
                     <div class="row">
                        @foreach($bags as $product)
                        <div class="col-xl-3 col-lg-3 col-sm-6">
                           <div class="tp-product-item p-relative transition-3 mb-25">
                  ...
                  <!-- Sports Wear Products Tab -->
                  <div class="tab-pane fade" id="gloves-bags-tab-pane" role="tabpanel" aria-labelledby="gloves-bags-tab">
                     <div class="row">
                        @foreach($sportswear as $product)
                        <div class="col-xl-3 col-lg-3 col-sm-6">
                           <div class="tp-product-item p-relative transition-3 mb-25">
                              <div class="tp-product-thumb p-relative fix m-img">
                                 <a href="{{ route('product-detail', $product->item_id) }}">
...
<!-- product area end -->
      ...
      <!-- banner area start -->
      <h3 class="tp-section-title" style="text-align:center" >Hot Products</h3>
   ...
   <div class="container">
      ...
      <div class="col-xl-4 col-lg-5">
            <div class="tp-banner-item tp-banner-item-sm tp-banner-height p-relative mb-30 z-index-1 fix">
               <!-- Banner thumb with background image properly fitted -->
               <div class="tp-banner-thumb include-bg transition-3" 
                    style="background-image: url('{{asset($gymwear1->picture)}}'); 
                           background-size: contain; 
                           background-position: center;">
                  <!-- Dark overlay for better text visibility -->
                  <div class="tp-banner-overlay" style="background: rgba(0, 0, 0, 0.5); position: absolute; width: 100%; height: 100%;"></div>
               </div>
            </div>
            <div class="tp-banner-content">
               <h3 class="tp-banner-title" style="color: #fff; text-shadow: 0 2px 5px rgba(0,0,0,0.5);">
                  <a href="{{route('product-detail', $gymwear1->item_id) }}">{{$gymwear1->itemname}}</a>
               </h3>
               <p style="color: #fff; text-shadow: 0 2px 5px rgba(0,0,0,0.5);"></p>
      ...
      <div class="col-xl-4 col-lg-5">
            <div class="tp-banner-item tp-banner-item-sm tp-banner-height p-relative mb-30 z-index-1 fix">
               <!-- Banner thumb with background image properly fitted -->
               <div class="tp-banner-thumb include-bg transition-3" 
                    style="background-image: url('{{asset($bag1->picture)}}'); 
                           background-size: contain; 
                           background-position: center;">
                  <!-- Dark overlay for better text visibility -->
                  <div class="tp-banner-overlay" style="background: rgba(0, 0, 0, 0.5); position: absolute; width: 100%; height: 100%;"></div>
            ...
            <div class="tp-banner-content">
               <h3 class="tp-banner-title" style="color: #fff; text-shadow: 0 2px 5px rgba(0,0,0,0.5);">
                  <a href="{{route('product-detail', $bag1->item_id) }}">{{$bag1->itemname}}</a>
               </h3>
               <p style="color: #fff; text-shadow: 0 2px 5px rgba(0,0,0,0.5);"></p>
         ...
         <div class="col-xl-4 col-lg-5">
            <div class="tp-banner-item tp-banner-item-sm tp-banner-height p-relative mb-30 z-index-1 fix">
               <!-- Banner thumb with background image properly fitted -->
               <div class="tp-banner-thumb include-bg transition-3" 
                    style="background-image: url('{{asset($sportswear1->picture)}}'); 
                           background-size: contain; 
                           background-position: center;">
                  <!-- Dark overlay for better text visibility -->
                  <div class="tp-banner-overlay" style="background: rgba(0, 0, 0, 0.5); position: absolute; width: 100%; height: 100%;"></div>
            ...
            <div class="tp-banner-content">
               <h3 class="tp-banner-title" style="color: #fff; text-shadow: 0 2px 5px rgba(0,0,0,0.5);">
                  <a href="{{route('product-detail', $sportswear1->item_id) }}">{{$sportswear1->itemname}}</a>
               </h3>
               <p style="color: #fff; text-shadow: 0 2px 5px rgba(0,0,0,0.5);"></p>
               ...
               <div class="row">
                  <div class="col-xl-4 col-lg-5">
                     <div class="tp-product-gadget-sidebar mb-40">
                        <div class="tp-product-gadget-categories p-relative fix mb-10">
                           ...
                           <h3 class="tp-product-gadget-categories-title">Leather Products</h3>

                           <div class="tp-product-gadget-categories-list">
                              <ul>
                                 <li><a href="{{route('shop-category')}}">Leather Jackets</a></li>
                                 <li><a href="{{route('shop-category')}}">Leather Gloves</a></li>
                                 <li><a href="{{route('shop-category')}}">Leather Pants</a></li>
                                 <li><a href="{{route('shop-category')}}">Leather Coats</a></li>
                                 <li><a href="{{route('shop-category')}}">Leather Vests</a></li>
                                 <li><a href="{{route('shop-category')}}">Leather Chaps</a></li>
                              </ul>
                           </div>

                           <div class="tp-product-gadget-btn">
                              <a href="{{route('shop-category')}}" class="tp-link-btn">More Products 
                        ...
                        <div class="tp-product-gadget-banner">
                           <div class="tp-product-gadget-banner-slider-active swiper-container">
                              <div class="swiper-wrapper">
                                 <div class="tp-product-gadget-banner-item swiper-slide include-bg" data-background="{{asset('website/assets/img/product/gadget/gadget-banner-1.jpeg')}}">
                                    <div class="tp-product-gadget-banner-content">
                                       <span class="tp-product-gadget-banner-price"></span>
                                       <h3 class="tp-product-gadget-banner-title">
                                          <a href="{{route('shop-category') }}">Selected novelty <br> Products</a>
                                       </h3>
                                    </div>
                                 </div>
                                 <div class="tp-product-gadget-banner-item swiper-slide include-bg" data-background="{{asset('website/assets/img/product/gadget/gadget-banner-2.jpeg')}}">
                                    <div class="tp-product-gadget-banner-content">
                                       <span class="tp-product-gadget-banner-price"></span>
                                       <h3 class="tp-product-gadget-banner-title">
                                          <a href="{{route('shop-category') }}">Top Rated <br> Products</a>
                                       </h3>
                                    </div>
                                 </div>
                              </div>
                  ...
                  <div class="col-xl-8 col-lg-7">
                     <div class="tp-product-gadget-wrapper">
                        <div class="row">
                           @foreach($leatherProducts as $product)
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 <div class="tp-product-thumb p-relative fix m-img">
                                    <a href="{{route('product-detail', $product->item_id) }}">
                                       <img src="{{asset($product->picture)}}" alt="product-electronic">
                                    </a>
                  ...
                  <div class="tp-product-banner-slider-active swiper-container">
                     <div class="swiper-wrapper">
                        <div class="tp-product-banner-inner theme-bg p-relative z-index-1 fix swiper-slide">
                           <h4 class="tp-product-banner-bg-text">Sports Wear</h4>
                           <div class="row align-items-center">
                              <div class="col-xl-6 col-lg-6">
                                 <div class="tp-product-banner-content p-relative z-index-1">
                                    <span class="tp-product-banner-subtitle">Sports Wear Collection</span>
                                    <h3 class="tp-product-banner-title">{{$sportswear1->itemname}}</h3>
                                    <div class="tp-product-banner-price mb-40">
                                       
                                    </div>
                                    <div class="tp-product-banner-btn">
                                       <a href="{{route('product-detail', $sportswear1->item_id)}}" class="tp-btn tp-btn-2">Shop now</a>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-xl-6 col-lg-6">
                                 <div class="tp-product-banner-thumb-wrapper p-relative">
                                    ...
                                    <div >
                                       <img src="{{asset($sportswear1->picture)}}" height="550px" width="550px" alt="">
                                    </div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="tp-product-banner-inner theme-bg p-relative z-index-1 fix swiper-slide">
                           <h4 class="tp-product-banner-bg-text">Gym Wear</h4>
                           <div class="row align-items-center">
                              <div class="col-xl-6 col-lg-6">
                                 <div class="tp-product-banner-content p-relative z-index-1">
                                    <span class="tp-product-banner-subtitle">Gym Wear</span>
                                    <h3 class="tp-product-banner-title">{{$gymwear1->itemname}}</h3>
                                    <div class="tp-product-banner-price mb-40">
                                       
                                    </div>
                                    <div class="tp-product-banner-btn">
                                       <a href="{{route('product-detail', $gymwear1->item_id)}}" class="tp-btn tp-btn-2">Shop now</a>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-xl-6 col-lg-6">
                                 <div class="tp-product-banner-thumb-wrapper p-relative">
                                    ...
                                    <div class="tp-product-banner-thumb text-end p-relative z-index-1">
                                       <img src="{{asset($gymwear1->picture)}}" height="550px" width="550px" alt="">
                                    </div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="tp-product-banner-inner theme-bg p-relative z-index-1 fix swiper-slide">
                           <h4 class="tp-product-banner-bg-text">Leather Products</h4>
                           <div class="row align-items-center">
                              <div class="col-xl-6 col-lg-6">
                                 <div class="tp-product-banner-content p-relative z-index-1">
                                    <span class="tp-product-banner-subtitle">Leather Garments</span>
                                    <h3 class="tp-product-banner-title">{{$leather1->itemname}}</h3>
                                    <div class="tp-product-banner-price mb-40">
                                       
                                    </div>
                                    <div class="tp-product-banner-btn">
                                       <a href="{{route('product-detail', $leather1->item_id)}}" class="tp-btn tp-btn-2">Shop now</a>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-xl-6 col-lg-6">
                                 <div class="tp-product-banner-thumb-wrapper p-relative">
                                    ...
                                    <div class="tp-product-banner-thumb text-end p-relative z-index-1">
                                       <img src="{{asset($leather1->picture)}}" height="550px" width="550px" alt="">
                                    </div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="tp-product-arrival-active swiper-container">
                           <div class="swiper-wrapper">
                              ...
                              <div class="tp-product-item transition-3 mb-25 swiper-slide">
                                 <div class="tp-product-thumb p-relative fix m-img">
                                    <a href="{{route('product-detail', $product->item_id) }}">
                                       <img src="{{asset($product->picture)}}" width="350px" height="250px" alt="product-electronic">
                                    </a>
         
                                    <!-- product badge -->
                                    <div class="tp-product-badge">
                                       <span class="product-trending">New Arrival</span>
                                    </div>
               ...
               <div class="row">
                  ...
                  <div class="col-xl-4 col-md-6">
                     <div class="tp-product-sm-list mb-50">
                        ...
                        <div class="tp-product-sm-wrapper mr-20">
                           @foreach($randomLeather as $product)
                           <div class="tp-product-sm-item d-flex align-items-center">
                              <div class="tp-product-thumb mr-25 fix">
                                 <a href="{{route('product-detail', $product->item_id) }}">
                                    <img src="{{asset($product->picture)}}" width ="200px" height="200px" alt="">
                        ...
                        <div class="tp-blog-main-slider-active swiper-container">
                           <div class="swiper-wrapper">
                              ...
                              <div class="tp-blog-item mb-30 swiper-slide">
                                 <div class="tp-blog-thumb p-relative fix">
                                    ...
                                    <div class="tp-blog-meta tp-blog-meta-date">
                                       <span>{{ \Carbon\Carbon::parse($blogs->created_at)->format('d F Y') }}</span>
                                    </div>
                                 </div>
                                 <div class="tp-blog-content">
                                    <h3 class="tp-blog-title">
                                       <a href="{{route('blog-details')}}">{{$blogs->title}}</a>
                                    </h3>
                                    ...
                                    <div class="tp-blog-btn">
                                       <a href="{{route('blog')}}" class="tp-btn-2 tp-btn-border-2">
                                          Read Blog 
                                          <span>
                              ...
                              <div class="tp-blog-item mb-30 swiper-slide">
                                 ...
                                 <div class="tp-blog-content">
                                    <h3 class="tp-blog-title">
                                       <a href="{{route('blog')}}">How clothes are linked to climate</a>
                                    </h3>
                              ...
                              <div class="tp-blog-item mb-30 swiper-slide">
                                 ...
                                 <div class="tp-blog-content">
                                    <h3 class="tp-blog-title">
                                       <a href="{{route('blog')}}">The Sound Of Fashion: Malcolm</a>
                                    </h3>
                                    ...
                                    <div class="tp-blog-btn">
                                       <a href="{{route('blog-details')}}" class="tp-btn-2 tp-btn-border-2">
                                          Read Blog 
                                          <span>
                                             <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M16 7.5L1 7.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
