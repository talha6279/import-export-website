            ...
            <div class="tp-slider-active-4 khaki-bg">
               <div class="tp-slider-item-4 tp-slider-height-4 p-relative khaki-bg d-flex align-items-center" >
                  <div class="tp-slider-thumb-4">
                     <img src="{{asset('website/assets/img/slider/4/slider-1.png')}}" alt="">
                  ...
                  <div class="tp-slider-video-wrapper">
                     ...
                     <div class="tp-slider-play">
                        ...
                        <button type="button" class="tp-slider-play-btn tp-slider-video-move-btn tp-video-toggle-btn">
                           <img class="text-shape" src="{{asset('website/assets/img/slider/4/shape/rounded-test.png')}}" alt="">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-8">
                           <div class="tp-slider-content-4 p-relative z-index-1">
                              ...
                              <div class="tp-slider-btn-4">
                                 <a href="{{route('shop')}}" class="tp-btn tp-btn-border tp-btn-border-white">Discover Now</a>
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div class="tp-slider-item-4 tp-slider-height-4 p-relative khaki-bg d-flex align-items-center" >
                  <div class="tp-slider-thumb-4">
                     <img src="{{asset('website/assets/img/slider/4/slider-2.png')}}" alt="">
                     <div class="tp-slider-thumb-4-shape">
                        <span class="tp-slider-thumb-4-shape-1"></span>
                        <span class="tp-slider-thumb-4-shape-2"></span>
                     </div>
               ...
               <div class="tp-slider-item-4 tp-slider-height-4 p-relative khaki-bg d-flex align-items-center" >
                  <div class="tp-slider-thumb-4">
                     <img src="{{asset('website/assets/img/slider/4/slider-3.png')}}" alt="">
                     <div class="tp-slider-thumb-4-shape">
                        <span class="tp-slider-thumb-4-shape-1"></span>
                        <span class="tp-slider-thumb-4-shape-2"></span>
                     </div>
               ...
               <div class="tp-slider-item-4 tp-slider-height-4 p-relative khaki-bg d-flex align-items-center" >
                  <div class="tp-slider-thumb-4">
                     <img src="{{asset('website/assets/img/slider/4/slider-4.png')}}" alt="">
                     <div class="tp-slider-thumb-4-shape">
                        <span class="tp-slider-thumb-4-shape-1"></span>
                        <span class="tp-slider-thumb-4-shape-2"></span>
                     </div>
                     ...
                     <div class="tp-slider-nav-active">
                        <div class="tp-slider-nav-item d-flex align-items-center">
                           <div class="tp-slider-nav-icon">
                              <span>
                                 <img src="{{asset('website/assets/img/slider/4/nav/icon-1.png')}}" alt="">
                              </span>
                           </div>
                        ...
                        <div class="tp-slider-nav-item d-flex align-items-center">
                           <div class="tp-slider-nav-icon">
                              <span>
                                 <img src="{{asset('website/assets/img/slider/4/nav/icon-2.png')}}" alt="">
                              </span>
                           </div>
                           <div class="tp-slider-nav-content">
                        ...
                        <div class="tp-slider-nav-item d-flex align-items-center">
                           <div class="tp-slider-nav-icon">
                              <span>
                                 <img src="{{asset('website/assets/img/slider/4/nav/icon-3.png')}}" alt="">
                              </span>
                           </div>
                           <div class="tp-slider-nav-content">
                        ...
                        <div class="tp-slider-nav-item d-flex align-items-center">
                           <div class="tp-slider-nav-icon">
                              <span>
                                 <img src="{{asset('website/assets/img/slider/4/nav/icon-4.png')}}" alt="">
                              </span>
                           </div>
                           <div class="tp-slider-nav-content">
               ...
               <div class="row">
                     ...
                     <div class="row">
                        <div class="col-xl-12">
                           <div class="tp-banner-item-4 tp-banner-height-4 fix p-relative z-index-1 mb-25" data-bg-color="#F3F7FF">
                              <div class="tp-banner-thumb-4 include-bg black-bg transition-3" data-background="{{asset('website/assets/img/banner/4/banner-1.jpg')}}"></div>
                              <div class="tp-banner-content-4">
                                 <span>Collection</span>
                                 <h3 class="tp-banner-title-4">
                                    <a href="{{route('shop')}}">Ardeco pearl <br> Rings style 2023</a>
                                 </h3>
                                 <div class="tp-banner-btn-4">
                                    <a href="{{route('shop')}}" class="tp-btn tp-btn-border">
                                       Shop Now
                        ...
                        <div class="col-md-6 col-sm-6">
                           <div class="tp-banner-item-4 tp-banner-height-4 fix p-relative z-index-1 has-green sm-banner" data-bg-color="#F0F6EF">
                              <div class="tp-banner-thumb-4 include-bg black-bg transition-3" data-background="{{asset('website/assets/img/banner/4/banner-2.jpg')}}"></div>
                              <div class="tp-banner-content-4">
                                 <span>Trending</span>
                                 <h3 class="tp-banner-title-4">
                                    <a href="{{route('shop')}}">Tropical Set</a>
                                 </h3>
                        ...
                        <div class="col-md-6 col-sm-6">
                           <div class="tp-banner-item-4 tp-banner-height-4 fix p-relative z-index-1 has-brown sm-banner" data-bg-color="#F8F1E6">
                              <div class="tp-banner-thumb-4 include-bg black-bg transition-3" data-background="{{asset('website/assets/img/banner/4/banner-3.jpg')}}"></div>
                              <div class="tp-banner-content-4">
                                 <span>New Arrival</span>
                                 <h3 class="tp-banner-title-4">
                                    <a href="{{route('shop')}}">Gold Jewelry</a>
                                 </h3>
                  ...
                  <div class="col-xl-6 col-lg-5">
                     <div class="tp-banner-full tp-banner-full-height fix p-relative z-index-1">
                        <div class="tp-banner-full-thumb include-bg black-bg transition-3" data-background="{{asset('website/assets/img/banner/4/banner-4.jpg')}}"></div>
                        <div class="tp-banner-full-content">
                           <span>Collection</span>
                           <h3 class="tp-banner-full-title">
                              <a href="{{route('shop')}}">Ring gold with <br> diamonds</a>
                           </h3>
                  ...
                  <div class="col-xl-5 col-lg-6">
                     <div class="tp-about-thumb-wrapper p-relative mr-35">
                        <div class="tp-about-thumb m-img">
                           <img src="{{asset('website/assets/img/about/about-1.jpg')}}" alt="">
                        </div>
                        <div class="tp-about-thumb-2">
                           <img src="{{asset('website/assets/img/about/about-2.jpg')}}" alt="">
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="tp-about-wrapper pl-80 pt-75 pr-60">
                        ...
                        <div class="tp-about-content pl-120">
                           ...
                           <div class="tp-about-btn">
                              <a href="{{route('contact')}}" class="tp-btn">
                                 Contact Us
                                 <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="tp-category-slider-active-4 swiper-container mb-70">
                           <div class="swiper-wrapper">
                              <div class="tp-category-item-4 p-relative z-index-1 fix swiper-slide text-center">
                                 <div class="tp-category-thumb-4 include-bg" data-background="{{asset('website/assets/img/category/4/category-1.jpg')}}"></div>
                                 <!-- product action -->
                                 ...
                                 <div class="tp-category-content-4">
                                    <h3 class="tp-category-title-4">
                                       <a href="{{route('product-detail')}}">Sigma Bracelet</a>
                                    </h3>
                              ...
                              <div class="tp-category-item-4 p-relative z-index-1 fix swiper-slide text-center">
                                 <div class="tp-category-thumb-4 include-bg" data-background="{{asset('website/assets/img/category/4/category-2.jpg')}}"></div>
                                 <!-- product action -->
                                 <div class="tp-product-action-3 tp-product-action-4 tp-product-action-blackStyle tp-product-action-brownStyle">
                                    <div class="tp-product-action-item-3 d-flex flex-column">
                                       <button type="button" class="tp-product-action-btn-3 tp-product-add-cart-btn">
                                 ...
                                 <div class="tp-category-content-4">
                                    <h3 class="tp-category-title-4">
                                       <a href="{{route('product-detail')}}">Dôme Earrings</a>
                                    </h3>
                                    <div class="tp-category-price-wrapper-4">
                              ...
                              <div class="tp-category-item-4 p-relative z-index-1 fix swiper-slide text-center">
                                 <div class="tp-category-thumb-4 include-bg" data-background="{{asset('website/assets/img/category/4/category-3.jpg')}}"></div>
                                 <!-- product action -->
                                 <div class="tp-product-action-3 tp-product-action-4 tp-product-action-blackStyle tp-product-action-brownStyle">
                                    <div class="tp-product-action-item-3 d-flex flex-column">
                                       <button type="button" class="tp-product-action-btn-3 tp-product-add-cart-btn">
                                 ...
                                 <div class="tp-category-content-4">
                                    <h3 class="tp-category-title-4">
                                       <a href="{{route('product-detail')}}">Stackable Ring</a>
                                    </h3>
                                    <div class="tp-category-price-wrapper-4">
                              ...
                              <div class="tp-category-item-4 p-relative z-index-1 fix swiper-slide text-center">
                                 <div class="tp-category-thumb-4 include-bg" data-background="{{asset('website/assets/img/category/4/category-4.jpg')}}"></div>
                                 <!-- product action -->
                                 <div class="tp-product-action-3 tp-product-action-4 tp-product-action-blackStyle tp-product-action-brownStyle">
                                    <div class="tp-product-action-item-3 d-flex flex-column">
                                       <button type="button" class="tp-product-action-btn-3 tp-product-add-cart-btn">
                                 ...
                                 <div class="tp-category-content-4">
                                    <h3 class="tp-category-title-4">
                                       <a href="{{route('product-detail')}}">Charms & Pendants</a>
                                    </h3>
                                    <div class="tp-category-price-wrapper-4">
                              ...
                              <div class="tp-category-item-4 p-relative z-index-1 fix swiper-slide text-center">
                                 <div class="tp-category-thumb-4 include-bg" data-background="{{asset('website/assets/img/category/4/category-5.jpg')}}"></div>
                                 <!-- product action -->
                                 <div class="tp-product-action-3 tp-product-action-4 tp-product-action-blackStyle tp-product-action-brownStyle">
                                    <div class="tp-product-action-item-3 d-flex flex-column">
                                       <button type="button" class="tp-product-action-btn-3 tp-product-add-cart-btn">
                                 ...
                                 <div class="tp-category-content-4">
                                    <h3 class="tp-category-title-4">
                                       <a href="{{route('product-detail')}}">Nacklaces</a>
                                    </h3>
                                    <div class="tp-category-price-wrapper-4">
                           ...
                           <div class="row">
                                 ...
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="{{route('product-detail')}}">
                                          <img src="{{asset('website/assets/img/product/4/product-1.jpg')}}" alt="">
                                       </a>
                                       <!-- product action -->
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="{{route('product-detail')}}">Marmont gold-tone ring</a>
                                       </h3>
                              ...
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="{{route('product-detail')}}">
                                          <img src="{{asset('website/assets/img/product/4/product-2.jpg')}}" alt="">
                                       </a>
                                       <!-- product action -->
                                       <div class="tp-product-action-3 tp-product-action-4 has-shadow tp-product-action-blackStyle tp-product-action-brownStyle">
                                          <div class="tp-product-action-item-3 d-flex flex-column">
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="{{route('product-detail')}}">Pop gold baselight</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                              ...
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="{{route('product-detail')}}">
                                          <img src="{{asset('website/assets/img/product/4/product-3.jpg')}}" alt="">
                                       </a>
                                       <!-- product action -->
                                       <div class="tp-product-action-3 tp-product-action-4 has-shadow tp-product-action-blackStyle tp-product-action-brownStyle">
                                          <div class="tp-product-action-item-3 d-flex flex-column">
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="{{route('product-detail')}}">Diamond vintage ring</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                                          <p>14k yellow gold</p>
                                       </div>
                              ...
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="{{route('product-detail')}}">
                                          <img src="{{asset('website/assets/img/product/4/product-4.jpg')}}" alt="">
                                       </a>
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="{{route('product-detail')}}">Amber earrings close-up</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                              ...
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="{{route('product-detail')}}">
                                          <img src="{{asset('website/assets/img/product/4/product-5.jpg')}}" alt="">
                                       </a>
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="{{route('product-detail')}}">Gold malachite earrings</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                                          <p>Sterling silver erring</p>
                                       </div>
                              ...
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="{{route('product-detail')}}">
                                          <img src="{{asset('website/assets/img/product/4/product-6.jpg')}}" alt="">
                                       </a>
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="{{route('product-detail')}}">Gold jewellery baselight</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                                          <p>14k yellow gold</p>
                                       </div>
                              ...
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="{{route('product-detail')}}">
                                          <img src="{{asset('website/assets/img/product/4/product-7.jpg')}}" alt="">
                                       </a>
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="{{route('product-detail')}}">Prong diamond ring</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                                          <p>Gold vermeil, pearl</p>
                                       </div>
                              ...
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="{{route('product-detail')}}">
                                          <img src="{{asset('website/assets/img/product/4/product-8.jpg')}}" alt="">
                                       </a>
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="{{route('product-detail')}}">Malachite earrings</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                                          <p>14k yellow gold</p>
                                       </div>
                  ...
                  <div class="row gx-0">
                     <div class="col-xl-6 col-lg-6">
                        <div class="tp-collection-thumb-wrapper-4 p-relative fix z-index-1" >
                           <div class="tp-collection-thumb-4 include-bg black-bg" data-background="{{asset('website/assets/img/product/collection/4/collection-1.jpg')}}"></div>
                     ...
                     <div class="col-xl-6 col-lg-6">
                        <div class="tp-collection-wrapper-4 p-relative pt-90 pb-95" data-bg-color="#F6F6F6">
                           <span class="tp-collection-side-text">
                              <img src="{{asset('website/assets/img/product/collection/4/side-text.png')}}" alt="">
                           </span>
                              ...
                              <div class="col-xl-6 col-lg-8">
                                 <div class="tp-collection-item-4 text-center">
                                    ...
                                    <div class="tp-collection-thumb-banner-4 m-img">
                                       <a href="{{route('shop')}}">
                                          <img src="{{asset('website/assets/img/product/collection/4/collection-sm-1.jpg')}}" alt="">
                                       </a>
                                    </div>
                                    <div class="tp-collection-content-4">
                                       <h3 class="tp-collection-title-4">
                                          <a href="{{route('shop')}}">Our finest jewelry</a>
                                       </h3>
                                       <div class="tp-collection-btn-4">
                                          <a href="{{route('shop')}}" class="tp-link-btn-line-2">
                           ...
                           <div class="swiper-wrapper">
                              <div class="tp-best-item-4 swiper-slide">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="{{route('product-detail')}}">
                                          <img src="{{asset('website/assets/img/product/4/product-9.jpg')}}" alt="">
                                       </a>
                                       <!-- product action -->
                                       <div class="tp-product-action-3 tp-product-action-4 has-shadow tp-product-action-blackStyle tp-product-action-brownStyle">
                                          <div class="tp-product-action-item-3 d-flex flex-column">
                              ...
                              <div class="tp-best-item-4 swiper-slide">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="{{route('product-detail')}}">
                                          <img src="{{asset('website/assets/img/product/4/product-10.jpg')}}" alt="">
                                       </a>
                                       <!-- product action -->
                                       <div class="tp-product-action-3 tp-product-action-4 has-shadow tp-product-action-blackStyle tp-product-action-brownStyle">
                                          <div class="tp-product-action-item-3 d-flex flex-column">
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="{{route('product-detail')}}">Diamond vintage earrings</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                                          <p>14k yellow gold</p>
                                       </div>
                              ...
                              <div class="tp-best-item-4 swiper-slide">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="{{route('product-detail')}}">
                                          <img src="{{asset('website/assets/img/product/4/product-11.jpg')}}" alt="">
                                       </a>
                                       <!-- product action -->
                                       <div class="tp-product-action-3 tp-product-action-4 has-shadow tp-product-action-blackStyle tp-product-action-brownStyle">
                                          <div class="tp-product-action-item-3 d-flex flex-column">
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="{{route('product-detail')}}">Gold ring with diamonds</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                                          <p>Gold vermeil, pearl</p>
                                       </div>
                              ...
                              <div class="tp-best-item-4 swiper-slide">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    <div class="tp-product-thumb-4 w-img fix">
                                       <a href="{{route('product-detail')}}">
                                          <img src="{{asset('website/assets/img/product/4/product-12.jpg')}}" alt="">
                                       </a>
                                       <!-- product action -->
                                       <div class="tp-product-action-3 tp-product-action-4 has-shadow tp-product-action-blackStyle tp-product-action-brownStyle">
                                          <div class="tp-product-action-item-3 d-flex flex-column">
                              ...
                              <div class="tp-best-item-4 swiper-slide">
                                 <div class="tp-product-item-4 p-relative mb-40">
                                    ...
                                    <div class="tp-product-content-4">
                                       <h3 class="tp-product-title-4">
                                          <a href="{{route('product-detail')}}">Diamond Plateted Ring</a>
                                       </h3>
                                       <div class="tp-product-info-4">
                                          <p>Gold vermeil, white topaz</p>
                                       </div>
                        ...
                        <div class="tp-brand-slider-active swiper-container">
                           <div class="swiper-wrapper">
                              <div class="tp-brand-item swiper-slide text-center">
                                 <a href="#">
                                    <img src="{{asset('website/assets/img/brand/logo_01.png')}}" alt="">
                                 </a>
                              </div>
                              <div class="tp-brand-item swiper-slide text-center">
                                 <a href="#">
                                    <img src="{{asset('website/assets/img/brand/logo_02.png')}}" alt="">
                                 </a>
                              </div>
                              <div class="tp-brand-item swiper-slide text-center">
                                 <a href="#">
                                    <img src="{{asset('website/assets/img/brand/logo_03.png')}}" alt="">
                                 </a>
                              </div>
                              <div class="tp-brand-item swiper-slide text-center">
                                 <a href="#">
                                    <img src="{{asset('website/assets/img/brand/logo_04.png')}}" alt="">
                                 </a>
                              </div>
                              <div class="tp-brand-item swiper-slide text-center">
                                 <a href="#">
                                    <img src="{{asset('website/assets/img/brand/logo_05.png')}}" alt="">
                                 </a>
                              </div>
                           </div>
                        </div>
               ...
               <div class="row row-cols-lg-6 row-cols-sm-2 row-cols-1 gx-2 gy-2 gy-lg-0">
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="{{asset('website/assets/img/instagram/4/instagram-1.jpg')}}" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="{{asset('website/assets/img/instagram/4/instagram-1.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="{{asset('website/assets/img/instagram/4/instagram-2.jpg')}}" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="{{asset('website/assets/img/instagram/4/instagram-2.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="{{asset('website/assets/img/instagram/4/instagram-3.jpg')}}" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="{{asset('website/assets/img/instagram/4/instagram-3.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="{{asset('website/assets/img/instagram/4/instagram-4.jpg')}}" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="{{asset('website/assets/img/instagram/4/instagram-4.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="{{asset('website/assets/img/instagram/4/instagram-5.jpg')}}" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="{{asset('website/assets/img/instagram/4/instagram-5.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="{{asset('website/assets/img/instagram/4/instagram-6.jpg')}}" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="{{asset('website/assets/img/instagram/4/instagram-6.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
               </div>
                        ...
                        <nav>
                           <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                              <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="true">
                                 <img src="{{asset('website/assets/img/product/details/4/nav/product-details-nav-1.jpg')}}" alt="">
                              </button>
                              <button class="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2" type="button" role="tab" aria-controls="nav-2" aria-selected="false">
                                 <img src="{{asset('website/assets/img/product/details/4/nav/product-details-nav-2.jpg')}}" alt="">
                              </button>
                              <button class="nav-link" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3" type="button" role="tab" aria-controls="nav-3" aria-selected="false">
                                 <img src="{{asset('website/assets/img/product/details/4/nav/product-details-nav-3.jpg')}}" alt="">
                              </button>
                        ...
                        <div class="tab-content m-img" id="productDetailsNavContent">
                           <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab" tabindex="0">
                              <div class="tp-product-details-nav-main-thumb">
                                 <img src="{{asset('website/assets/img/product/details/4/main/product-details-main-1.jpg')}}" alt="">
                              </div>
                           </div>
                           <div class="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab" tabindex="0">
                              <div class="tp-product-details-nav-main-thumb">
                                 <img src="{{asset('website/assets/img/product/details/4/main/product-details-main-2.jpg')}}" alt="">
                              </div>
                           </div>
                           <div class="tab-pane fade" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab" tabindex="0">
                              <div class="tp-product-details-nav-main-thumb">
                                 <img src="{{asset('website/assets/img/product/details/4/main/product-details-main-3.jpg')}}" alt="">
                              </div>
                           </div>
                           <div class="tab-pane fade" id="nav-4" role="tabpanel" aria-labelledby="nav-4-tab" tabindex="0">
                              <div class="tp-product-details-nav-main-thumb">
                                 <img src="{{asset('website/assets/img/product/details/4/main/product-details-main-4.jpg')}}" alt="">
                              </div>
                           </div>
                         </div>
                     </div>
