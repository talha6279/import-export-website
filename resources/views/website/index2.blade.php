               ...
               <div class="swiper-wrapper">
                  <div class="tp-slider-item-2 tp-slider-height-2 p-relative swiper-slide grey-bg-5 d-flex align-items-end">
                     <div class="tp-slider-2-shape">
                        <img class="tp-slider-2-shape-1" src="{{asset('website/assets/img/slider/2/shape/shape-1.png')}}" alt="">
                     </div>
                     <div class="container">
                           ...
                           <div class="col-xl-6 col-lg-6 col-md-6">
                              <div class="tp-slider-content-2">
                                 ...
                                 <div class="tp-slider-btn-2">
                                    <a href="{{route('shop')}}" class="tp-btn tp-btn-border">Shop Collection</a>
                                 </div>
                              </div>
                           </div>
                           <div class="col-xl-6 col-lg-6 col-md-6">
                              <div class="tp-slider-thumb-2-wrapper p-relative">
                                 <div class="tp-slider-thumb-2-shape">
                                    <img class="tp-slider-thumb-2-shape-1" src="{{asset('website/assets/img/slider/2/shape/shape-2.png')}}" alt="">
                                    <img class="tp-slider-thumb-2-shape-2" src="{{asset('website/assets/img/slider/2/shape/shape-3.png')}}" alt="">
                                 </div>
                                 <div class="tp-slider-thumb-2 text-end">
                                    <span class="tp-slider-thumb-2-gradient"></span>
                                    <img src="{{asset('website/assets/img/slider/2/slider-1.png')}}" alt="">
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                           ...
                           <div class="col-xl-6 col-lg-6 col-md-6">
                              <div class="tp-slider-thumb-2-wrapper p-relative">
                                 ...
                                 <div class="tp-slider-thumb-2 text-end">
                                    <span class="tp-slider-thumb-2-gradient"></span>
                                    <img src="{{asset('website/assets/img/slider/2/slider-2.png')}}" alt="">
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                           ...
                           <div class="col-xl-6 col-lg-6 col-md-6">
                              <div class="tp-slider-thumb-2-wrapper p-relative">
                                 ...
                                 <div class="tp-slider-thumb-2 text-end">
                                    <span class="tp-slider-thumb-2-gradient"></span>
                                    <img src="{{asset('website/assets/img/slider/2/slider-3.png')}}" alt="">
                                 </div>
                              </div>
                           </div>
                        </div>
               ...
               <div class="row tp-gx-20">
                  <div class="col-xxl-4 col-lg-6">
                     <div class="tp-banner-item-2 p-relative z-index-1 grey-bg-2 mb-20 fix">
                        <div class="tp-banner-thumb-2 include-bg transition-3" data-background="{{asset('website/assets/img/banner/2/banner-1.jpg')}}"></div>
                        <h3 class="tp-banner-title-2">
                           <a href="{{route('shop')}}">T-Shirt Tunic <br> Tops Blouse</a>
                        </h3>
                        <div class="tp-banner-btn-2">
                           <a href="{{route('shop')}}" class="tp-btn tp-btn-border tp-btn-border-sm">Shop Now 
                  ...
                  <div class="col-xxl-4 col-lg-6">
                     <div class="tp-banner-item-2 p-relative z-index-1 grey-bg-2 mb-20 fix">
                        <div class="tp-banner-thumb-2 include-bg transition-3" data-background="{{asset('website/assets/img/banner/2/banner-2.jpg')}}"></div>
                        <h3 class="tp-banner-title-2">
                           <a href="{{route('shop')}}">Satchel Tote <br> Crossbody Bags</a>
                        </h3>
                        <div class="tp-banner-btn-2">
                           <a href="{{route('shop')}}" class="tp-btn tp-btn-border tp-btn-border-sm">Shop Now 
                              <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="col-xxl-4 col-lg-6">
                     <div class="tp-banner-item-2 p-relative z-index-1 grey-bg-2 mb-20 fix">
                        <div class="tp-banner-thumb-2 include-bg transition-3" data-background="{{asset('website/assets/img/banner/2/banner-3.jpg')}}"></div>
                        <h3 class="tp-banner-title-2">
                           <a href="{{route('shop')}}">Men's Tennis <br> Walking Shoes</a>
                        </h3>
                        <div class="tp-banner-btn-2">
                           <a href="{{route('shop')}}" class="tp-btn tp-btn-border tp-btn-border-sm">Shop Now 
                              <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                           ...
                           <div class="swiper-wrapper">
                              <div class="tp-category-item-2 p-relative z-index-1 text-center swiper-slide">
                                 <div class="tp-category-thumb-2">
                                    <a href="#">
                                       <img src="{{asset('website/assets/img/category/category-1.jpg')}}" alt="">
                                    </a>
                                 </div>
                                 <div class="tp-category-content-2">
                                    <span></span>
                                    <h3 class="tp-category-title-2">
                                       <a href="{{route('product-detail', $product->item_id)}}">Crew Neck T-shirt</a>
                                    </h3>
                                    <div class="tp-category-btn-2">
                                       <a href="{{route('product-detail', $product->item_id)}}" class="tp-btn tp-btn-border">Product Detail</a>
                                    </div>
                                 </div>
                              </div>
                              <div class="tp-category-item-2 p-relative z-index-1 text-center swiper-slide">
                                 <div class="tp-category-thumb-2">
                                    <a href="#">
                                       <img src="{{asset('website/assets/img/category/category-2.jpg')}}" alt="">
                                    </a>
                                 </div>
                                 <div class="tp-category-content-2">
                                    <span></span>
                              ...
                              <div class="tp-category-item-2 p-relative z-index-1 text-center swiper-slide">
                                 <div class="tp-category-thumb-2">
                                    <a href="#">
                                       <img src="{{asset('website/assets/img/category/category-3.jpg')}}" alt="">
                                    </a>
                                 </div>
                                 <div class="tp-category-content-2">
                                    <span></span>
                              ...
                              <div class="tp-category-item-2 p-relative z-index-1 text-center swiper-slide">
                                 <div class="tp-category-thumb-2">
                                    <a href="#">
                                       <img src="{{asset('website/assets/img/category/category-4.jpg')}}" alt="">
                                    </a>
                                 </div>
                                 <div class="tp-category-content-2">
                                    <span></span>
                              ...
                              <div class="tp-category-item-2 p-relative z-index-1 text-center swiper-slide">
                                 <div class="tp-category-thumb-2">
                                    <a href="#">
                                       <img src="{{asset('website/assets/img/category/category-5.jpg')}}" alt="">
                                    </a>
                                 </div>
                                 <div class="tp-category-content-2">
                                    <span></span>
                              ...
                              <div class="tp-category-item-2 p-relative z-index-1 text-center swiper-slide">
                                 <div class="tp-category-thumb-2">
                                    <a href="#">
                                       <img src="{{asset('website/assets/img/category/category-6.jpg')}}" alt="">
                                    </a>
                                 </div>
                                 <div class="tp-category-content-2">
                                    <span></span>
                                 ...
                                 <div class="tp-product-item-2 mb-40">
                                    ...
                                    <div class="tp-product-content-2 pt-15">
                                       ...
                                       <h3 class="tp-product-title-2">
                                          <a href="{{route('product-detail', $product->item_id)}}">Whitetails Women's Open Sky</a>
                                       </h3>
                              ...
                              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                 <div class="tp-product-item-2 mb-40">
                                    ...
                                    <div class="tp-product-content-2 pt-15">
                                       ...
                                       <h3 class="tp-product-title-2">
                                          <a href="{{route('product-detail', $product->item_id)}}">Simple Modern School Boys</a>
                                       </h3>
                                       <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                          <span><i class="fa-solid fa-star"></i></span>
                                          <span><i class="fa-solid fa-star"></i></span>
                              ...
                              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                 <div class="tp-product-item-2 mb-40">
                                    ...
                                    <div class="tp-product-content-2 pt-15">
                                       ...
                                       <h3 class="tp-product-title-2">
                                          <a href="{{route('product-detail', $product->item_id)}}">Women's Essentials Convertible</a>
                                       </h3>
                                       <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                          <span><i class="fa-solid fa-star"></i></span>
                                          <span><i class="fa-solid fa-star"></i></span>
                              ...
                              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                 <div class="tp-product-item-2 mb-40">
                                    ...
                                    <div class="tp-product-content-2 pt-15">
                                       ...
                                       <h3 class="tp-product-title-2">
                                          <a href="{{route('product-detail', $product->item_id)}}">Calvin Klein Gabrianna Novelty</a>
                                       </h3>
                                       <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                          <span><i class="fa-solid fa-star"></i></span>
                                          <span><i class="fa-solid fa-star"></i></span>
                              ...
                              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                 <div class="tp-product-item-2 mb-40">
                                    ...
                                    <div class="tp-product-content-2 pt-15">
                                       ...
                                       <h3 class="tp-product-title-2">
                                          <a href="{{route('product-detail', $product->item_id)}}">Tommy Hilfiger Women’s Jaden</a>
                                       </h3>
                                       <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                          <span><i class="fa-solid fa-star"></i></span>
                                          <span><i class="fa-solid fa-star"></i></span>
                              ...
                              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                 <div class="tp-product-item-2 mb-40">
                                    ...
                                    <div class="tp-product-content-2 pt-15">
                                       ...
                                       <h3 class="tp-product-title-2">
                                          <a href="{{route('product-detail', $product->item_id)}}">Govicta Men's Shoes Leather</a>
                                       </h3>
                                       <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                          <span><i class="fa-solid fa-star"></i></span>
                                          <span><i class="fa-solid fa-star"></i></span>
                              ...
                              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                 <div class="tp-product-item-2 mb-40">
                                    ...
                                    <div class="tp-product-content-2 pt-15">
                                       ...
                                       <h3 class="tp-product-title-2">
                                          <a href="{{route('product-detail', $product->item_id)}}">Legendary Whitetails Men's.</a>
                                       </h3>
                                       <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                          <span><i class="fa-solid fa-star"></i></span>
                                          <span><i class="fa-solid fa-star"></i></span>
                              ...
                              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                 <div class="tp-product-item-2 mb-40">
                                    ...
                                    <div class="tp-product-content-2 pt-15">
                                       ...
                                       <h3 class="tp-product-title-2">
                                          <a href="{{route('product-detail', $product->item_id)}}">Backpack, School Bag.</a>
                                       </h3>
                                       <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                          <span><i class="fa-solid fa-star"></i></span>
                                          <span><i class="fa-solid fa-star"></i></span>
                        ...
                        <div class="tp-featured-slider-active swiper-container">
                           <div class="swiper-wrapper">
                              <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                                 <div class="tp-featured-thumb include-bg" data-background="{{asset('website/assets/img/product/slider/product-slider-1.jpg')}}"></div>
                                 <div class="tp-featured-content">
                                    <h3 class="tp-featured-title">
                                       <a href="{{route('product-detail', $product->item_id)}}">Clothing <br> Collection 2023</a>
                                    </h3>
                                    ...
                                    <div class="tp-featured-btn">
                                       <a href="{{route('product-detail', $product->item_id)}}" class="tp-btn tp-btn-border tp-btn-border-sm">Shop Now 
                                          <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                             <path d="M16 7.49988L1 7.49988" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                             <path d="M9.9502 1.47554L16.0002 7.49954L9.9502 13.5245" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                          </svg>
                              ...
                              <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                                 <div class="tp-featured-thumb include-bg" data-background="{{asset('website/assets/img/product/slider/product-slider-2.jpg')}}"></div>
                                 <div class="tp-featured-content">
                                    <h3 class="tp-featured-title">
                                       <a href="{{route('product-detail', $product->item_id)}}">Non Slip Athletic <br> Tennis Walking</a>
                                    </h3>
                                    <div class="tp-featured-price-wrapper">
                              ...
                              <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                                 <div class="tp-featured-thumb include-bg" data-background="{{asset('website/assets/img/product/slider/product-slider-3.jpg')}}"></div>
                                 <div class="tp-featured-content">
                                    <h3 class="tp-featured-title">
                                       <a href="{{route('product-detail', $product->item_id)}}">Vera Bradley <br> Straw Tote Bag</a>
                                    </h3>
                                    <div class="tp-featured-price-wrapper">
                              ...
                              <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                                 <div class="tp-featured-thumb include-bg" data-background="{{asset('website/assets/img/product/slider/product-slider-4.jpg')}}"></div>
                                 <div class="tp-featured-content">
                                    <h3 class="tp-featured-title">
                                       <a href="{{route('product-detail', $product->item_id)}}">Gucci Women’s <br> Black Leather Bag</a>
                                    </h3>
                                    <div class="tp-featured-price-wrapper">
                                       <span class="tp-featured-price new-price">$102.00</span>
                                       <span class="tp-featured-price old-price">$226.00</span>
                              ...
                              <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                                 <div class="tp-featured-thumb include-bg" data-background="{{asset('website/assets/img/product/slider/product-slider-5.jpg')}}"></div>
                                 <div class="tp-featured-content">
                                    <h3 class="tp-featured-title">
                                       <a href="{{route('product-detail', $product->item_id)}}">Mens Jacket <br> Premium Cotton</a>
                                    </h3>
                                    <div class="tp-featured-price-wrapper">
               ...
               <div class="row justify-content-center">
                              ...
                              <div class="swiper-wrapper">
                                 <div class="tp-trending-item swiper-slide">
                                    <div class="tp-product-item-2">
                                       <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                          <a href="{{route('product-detail', $product->item_id)}}">
                                             <img src="{{asset('website/assets/img/product/trending/trending-1.jpg')}}" alt="">
                                          </a>
                                          <!-- product action -->
                                          <div class="tp-product-action-2 tp-product-action-blackStyle">
                                             <div class="tp-product-action-item-2 d-flex flex-column">
                                       ...
                                       <div class="tp-product-content-2 pt-15">
                                          ...
                                          <h3 class="tp-product-title-2">
                                             <a href="{{route('product-detail', $product->item_id)}}">Brown Gown for Women</a>
                                          </h3>
                                          <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                             <span><i class="fa-solid fa-star"></i></span>
                                             <span><i class="fa-solid fa-star"></i></span>
                                 ...
                                 <div class="tp-trending-item swiper-slide">
                                    <div class="tp-product-item-2">
                                       <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                          <a href="{{route('product-detail', $product->item_id)}}">
                                             <img src="{{asset('website/assets/img/product/trending/trending-2.jpg')}}" alt="">
                                          </a>
                                          <!-- product action -->
                                          <div class="tp-product-action-2 tp-product-action-blackStyle">
                                             <div class="tp-product-action-item-2 d-flex flex-column">
                                       ...
                                       <div class="tp-product-content-2 pt-15">
                                          ...
                                          <h3 class="tp-product-title-2">
                                             <a href="{{route('product-detail', $product->item_id)}}">Strip Shirt For Women (Green)</a>
                                          </h3>
                                          <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                             <span><i class="fa-solid fa-star"></i></span>
                                             <span><i class="fa-solid fa-star"></i></span>
                                 ...
                                 <div class="tp-trending-item swiper-slide">
                                    <div class="tp-product-item-2">
                                       <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                          <a href="{{route('product-detail', $product->item_id)}}">
                                             <img src="{{asset('website/assets/img/product/trending/trending-3.jpg')}}" alt="">
                                          </a>
                                          <!-- product action -->
                                          <div class="tp-product-action-2 tp-product-action-blackStyle">
                                             <div class="tp-product-action-item-2 d-flex flex-column">
                                       ...
                                       <div class="tp-product-content-2 pt-15">
                                          ...
                                          <h3 class="tp-product-title-2">
                                             <a href="{{route('product-detail', $product->item_id)}}">Deep Blue Dress </a>
                                          </h3>
                                          <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                             <span><i class="fa-solid fa-star"></i></span>
                                             <span><i class="fa-solid fa-star"></i></span>
                  ...
                  <div class="col-xl-4 col-lg-5 col-md-8 col-sm-10">
                     <div class="tp-trending-banner p-relative ml-35">
                        <div class="tp-trending-banner-thumb w-img include-bg" data-background="{{asset('website/assets/img/product/trending/banner/trending-banner.jpg')}}"></div>
                        <div class="tp-trending-banner-content">
                           <h3 class="tp-trending-banner-title">
                              <a href="{{route('shop')}}">Short Sleeve Tunic <br> Tops Casual Swing</a>
                           </h3>
                           <div class="tp-trending-banner-btn">
                              <a href="{{route('shop')}}" class="tp-btn tp-btn-border tp-btn-border-white tp-btn-border-white-sm">
                                 Explore More
                                 <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="col-xl-3 col-lg-4 col-sm-6">
                     <div class="tp-product-item-2 mb-40">
                        ...
                        <div class="tp-product-content-2 pt-15">
                           ...
                           <h3 class="tp-product-title-2">
                              <a href="{{route('product-detail', $product->item_id)}}">Backpack, School, Travel</a>
                           </h3>
                           <div class="tp-product-rating-icon tp-product-rating-icon-2">
                              <span><i class="fa-solid fa-star"></i></span>
                              <span><i class="fa-solid fa-star"></i></span>
               ...
               <div class="row">
                  <div class="col-xl-12">
                     <div class="tp-seller-more text-center mt-10">
                        <a href="{{route('shop')}}" class="tp-btn tp-btn-border tp-btn-border-sm">Shop All Product</a>
                     </div>
                  </div>
               </div>
            </div>
                                 ...
                                 <div class="swiper-wrapper">
                                    ...
                                    <div class="tp-testimonial-item text-center mb-20 swiper-slide">
                                       ...
                                       <div class="tp-testimonial-user-wrapper d-flex align-items-center justify-content-center">
                                          <div class="tp-testimonial-user d-flex align-items-center">
                                             <div class="tp-testimonial-avater mr-10">
                                                <img src="{{asset('website/assets/img/users/user-4.jpg')}}" alt="">
                                             </div>
                                             <div class="tp-testimonial-user-info tp-testimonial-user-translate">
               ...
               <div class="row">
                     ...
                     <div class="tp-blog-item-2 mb-40">
                        <div class="tp-blog-thumb-2 p-relative fix">
                           <a href="{{route('blog-details')}}">
                              <img src="{{asset('website/assets/img/blog/2/blog-1.jpg')}}" alt="">
                           </a>
                        ...
                        <div class="tp-blog-content-2 has-thumbnail">
                           ...
                           <h3 class="tp-blog-title-2">
                              <a href="{{route('blog-details')}}">The 'Boomerang' Employees Returning After Quitting</a>
                           </h3>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-4 col-lg-4 col-md-6">
                     <div class="tp-blog-item-2 mb-40">
                        <div class="tp-blog-thumb-2 p-relative fix">
                           <a href="{{route('blog-details')}}">
                              <img src="{{asset('website/assets/img/blog/2/blog-2.jpg')}}" alt="">
                           </a>
                           <div class="tp-blog-meta-date-2">
                        ...
                        <div class="tp-blog-content-2 has-thumbnail">
                           ...
                           <h3 class="tp-blog-title-2">
                              <a href="{{route('blog-details')}}">Fast fashion: How clothes are linked to climate change</a>
                           </h3>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-4 col-lg-4 col-md-6">
                     <div class="tp-blog-item-2 mb-40">
                        <div class="tp-blog-thumb-2 p-relative fix">
                           <a href="{{route('blog-details')}}">
                              <img src="{{asset('website/assets/img/blog/2/blog-3.jpg')}}" alt="">
                           </a>
                           <div class="tp-blog-meta-date-2">
                        ...
                        <div class="tp-blog-content-2 has-thumbnail">
                           ...
                           <h3 class="tp-blog-title-2">
                              <a href="{{route('blog-details')}}">The Sound Of Fashion: Malcolm McLaren Words</a>
                           </h3>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row">
                  <div class="col-xl-12">
                     <div class="tp-blog-more-2 mt-10 text-center">
                        <a href="{{route('blog')}}" class="tp-btn tp-btn-border tp-btn-border-sm">Discover More</a>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="row row-cols-lg-5 row-cols-sm-2 row-cols-1 gx-2 gy-2 gy-lg-0">
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="{{asset('website/assets/img/instagram/2/insta-1.jpg')}}" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="{{asset('website/assets/img/instagram/2/insta-1.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="{{asset('website/assets/img/instagram/2/insta-2.jpg')}}" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="{{asset('website/assets/img/instagram/2/insta-2.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-banner text-center">
                           <div class="tp-instagram-banner-icon mb-40">
                              <a href="#">
                                 <img src="{{asset('website/assets/img/instagram/2/insta-icon.png')}}" alt="">
                              </a>
                           </div>
                  ...
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="{{asset('website/assets/img/instagram/2/insta-3.jpg')}}" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="{{asset('website/assets/img/instagram/2/insta-3.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="{{asset('website/assets/img/instagram/2/insta-4.jpg')}}" alt="">
                        <div class="tp-instagram-icon-2">
                           <a href="{{asset('website/assets/img/instagram/2/insta-4.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
               </div>
                        ...
                        <nav>
                           <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                              <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="true">
                                 <img src="{{asset('website/assets/img/product/details/3/nav/product-details-nav-1.jpg')}}" alt="">
                              </button>
                              <button class="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2" type="button" role="tab" aria-controls="nav-2" aria-selected="false">
                                 <img src="{{asset('website/assets/img/product/details/3/nav/product-details-nav-2.jpg')}}" alt="">
                              </button>
                              <button class="nav-link" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3" type="button" role="tab" aria-controls="nav-3" aria-selected="false">
                                 <img src="{{asset('website/assets/img/product/details/3/nav/product-details-nav-3.jpg')}}" alt="">
                              </button>
                              <button class="nav-link" id="nav-4-tab" data-bs-toggle="tab" data-bs-target="#nav-4" type="button" role="tab" aria-controls="nav-4" aria-selected="false">
                                 <img src="{{asset('website/assets/img/product/details/3/nav/product-details-nav-4.jpg')}}" alt="">
                              </button>
                           </div>
                        </nav>
                        <div class="tab-content m-img" id="productDetailsNavContent">
                           <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab" tabindex="0">
                              <div class="tp-product-details-nav-main-thumb">
                                 <img src="{{asset('website/assets/img/product/details/3/main/product-details-main-1.jpg')}}" alt="">
                              </div>
                           </div>
                           <div class="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab" tabindex="0">
                              <div class="tp-product-details-nav-main-thumb">
                                 <img src="{{asset('website/assets/img/product/details/3/main/product-details-main-2.jpg')}}" alt="">
                              </div>
                           </div>
                           <div class="tab-pane fade" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab" tabindex="0">
                              <div class="tp-product-details-nav-main-thumb">
                                 <img src="{{asset('website/assets/img/product/details/3/main/product-details-main-3.jpg')}}" alt="">
                              </div>
                           </div>
                           <div class="tab-pane fade" id="nav-4" role="tabpanel" aria-labelledby="nav-4-tab" tabindex="0">
                              <div class="tp-product-details-nav-main-thumb">
                                 <img src="{{asset('website/assets/img/product/details/3/main/product-details-main-4.jpg')}}" alt="">
                              </div>
                           </div>
                         </div>
                     </div>
