               ...
               <div class="row">
                  <div class="col-xl-8 col-lg-10">
                     <div class="tp-about-banner-wrapper">
                        <span class="tp-about-banner-subtitle">Shofy</span>
                        <h3 class="tp-about-banner-title"> Quality, Innovation, and Customization</h3>
                     </div>
                  </div>
               </div>
               <div class="row">
               ...
               <div class="row">
                  <div class="col-xl-12">
                     <div class="tp-about-banner-content">
                        <p>At Shofy, we believe in creating a world where quality, style, and functionality come together. Our diverse product range, from elegant leather jackets to cutting-edge surgical instruments, showcases our commitment to delivering excellence across industries. Every custom-designed hoodie, player uniforms, bags, and glove is crafted with precision to meet your needs, whether for fashion or performance.</p>

                        <p>We understand that every product tells a story—of craftsmanship, innovation, and customer satisfaction. That’s why we go beyond expectations, offering you a seamless shopping experience with products tailored to your unique preferences. Join us at Shofy and discover a world where quality meets style, and functionality transforms into fashion.</p>
                     </div>
                  </div>
               </div>
            </div>
                                    ...
                                    <div class="col-xl-5 col-lg-6 col-md-6">
                                       <div class="tp-history-wrapper pr-45">
                                          <div class="tp-history-content mb-40">
                                             <h3 class="tp-history-title">About <br> Shofy</h3>
                                             <p>At Shofy, we are dedicated to bringing you top-quality, customizable products that cater to a variety of industries. From premium leather jackets to professional-grade surgical instruments, every item in our collection reflects our commitment to craftsmanship and excellence. With a focus on innovation and precision, we offer products that are as unique as your needs. Whether you’re looking for custom-designed apparel, sports uniforms, or durable bags and gloves, Shofy is here to deliver beyond expectations.</p>
                                             <p>Explore our diverse range and experience the perfect blend of quality, style, and functionality!</p>
                                    ...
                                    <div class="col-xl-7 col-lg-6 col-md-6">
                                       <div class="tp-history-thumb-wrapper ml-150 p-relative">
                                          <div class="tp-history-thumb-text">
                                             <p>Welcome to Shosfy <br>  - Your Gateway to Custom Designs and Quality Products</p>
                                          </div>
                                 ...
                                 <div class="row">
                                    <div class="col-xl-5 col-lg-6 col-md-6">
                                       <div class="tp-history-wrapper pr-110">
                                          <div class="tp-history-content mb-40">
                                             <h3 class="tp-history-title">About <br> Shofy</h3>
                                             <p>At Shofy, we are driven by a passion for delivering high-quality, customizable products across various categories. From stylish leather jackets to precision-crafted surgical instruments, every product we offer is designed with excellence in mind. We pride ourselves on offering a seamless shopping experience, exceptional customer service, and a wide selection of products that cater to both personal and professional needs.</p>
                                             <p>Start exploring today and discover the perfect products that reflect your style and purpose!</p>
                                    ...
                                    <div class="col-xl-7 col-lg-6 col-md-6">
                                       <div class="tp-history-thumb-wrapper ml-150 p-relative">
                                          <div class="tp-history-thumb-text">
                                             <p> The Beginning <br> of a Vision</p>
                                          </div>
                                          <div class="tp-history-thumb m-img">
                                 ...
                                 <div class="row">
                                    <div class="col-xl-5 col-lg-6 col-md-6">
                                       <div class="tp-history-wrapper pr-110">
                                          <div class="tp-history-content mb-40">
                                             <h3 class="tp-history-title">About  <br>  Shofy</h3>
                                             <p>In 2018, Shofy was born with a mission to revolutionize the import-export industry. Our goal was to create a platform where quality and customization meet convenience. With an initial focus on leather jackets and custom-designed apparel, Shofy quickly became a trusted name among those who sought unique, high-quality products. This year marked the start of our journey to becoming a global eCommerce brand.</p>
                                    ...
                                    <div class="col-xl-7 col-lg-6 col-md-6">
                                       <div class="tp-history-thumb-wrapper ml-150 p-relative">
                                          <div class="tp-history-thumb-text">
                                             <p>Expansion and  <br> Innovation</p>
                                          </div>
                                          <div class="tp-history-thumb m-img">
                                             <img src="assets/img/history/history-1.jpg" alt="">
                                          </div>
                                 ...
                                 <div class="row">
                                    <div class="col-xl-5 col-lg-6 col-md-6">
                                       <div class="tp-history-wrapper pr-110">
                                          <div class="tp-history-content mb-40">
                                             <h3 class="tp-history-title">About  <br>  Shofy</h3>
                                             <p>In 2019, we expanded our product range, adding new categories like gloves, player uniforms, and surgical instruments. This was the year when Shofy truly embraced innovation, offering customers not only variety but also the ability to personalize their orders. Our dedication to providing top-tier products, coupled with a customer-first approach, led to rapid growth and recognition across international markets.</p>
