                  ...
                  <div class="row">
                     ...
                     <div class="col-xl-5 col-lg-6">
                        <div class="tp-product-details-wrapper">
                           ...
                           <h3 class="tp-product-details-title">{{ $product->itemname }}</h3>
                           ...
                           <div class="tp-product-details-variation">
                              ...
                              <div class="tp-product-details-variation-item">
                                 <h4 class="tp-product-details-variation-title">Color : {{ $product->color }}</h4>
                           ...
                           <!-- actions -->
                                 ...
                                 <div class="tp-product-details-add-to-cart mb-15 w-100">
                                    <a href="mailto:talhachander50@gmail.com"><button class="tp-product-details-add-to-cart-btn w-100">Email</button></a>
                                 </div>
                              </div>
                              <a href="{{route('contact')}}"><button class="tp-product-details-buy-now-btn w-100">Contact Us to Buy Now</button></a>
                           </div>
                           ...
                           <div class="tp-product-details-query">
                              <div class="tp-product-details-query-item d-flex align-items-center">
                                 <span>Product : {{$product->itemname}}  </span>
                              </div>
                              <div class="tp-product-details-query-item d-flex align-items-center">
                           ...
                           <div class="tp-product-details-social">
                              <span>Supplier Social Links: </span>
                              <a href="https://wa.me/923099323779"><i class="fa-brands fa-whatsapp"></i></a>
                                             ...
                                             <div class="row">
                                                <div class="col-lg-6">
                                                   <div class="tp-product-details-desc-content pt-25">
                                                      ...
                                                      <h3 class="tp-product-details-desc-title">Short Detail</h3>
                                                      <p>{{$product->detail}}</p>
                                                   </div>
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-lg-5 order-first order-lg-last">
                                                   <div class="tp-product-details-desc-content des-content-2 pl-40">
                                                      <h3 class="tp-product-details-desc-title">Description</h3>
                                             ...
                                             <div class="row">
                                                <div class="col-xl-12">
                                                   <div class="tp-product-details-desc-banner text-center m-img">
                                                      <h3 class="tp-product-details-desc-banner-title tp-product-details-desc-title">Export Efficiency = Global Reach</h3>
                                                      <img src="{{ asset($product->picture2) }}" alt="">
                                                   </div>
                                                </div>
                                             </div>
