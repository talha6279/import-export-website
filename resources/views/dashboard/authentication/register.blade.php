                           ...
                           <div class="tp-login-input-wrapper">
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                    <input id="name" type="text" name="name" value="{{ old('name') }}" placeholder="Talha Chander">
                                 </div>
                              ...
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                    <input id="email" name="email" value="{{ old('email') }}" type="email" placeholder="talhachander50@gmail.com">
                                 </div>
                                 <div class="tp-login-input-title">
