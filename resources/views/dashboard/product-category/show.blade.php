    ...
    <tbody>
        @foreach($category as $cat)
            <tr>
                ...
                <td>
                    <a href="{{ route('product.category.edit', $cat->product_id) }}" class="btn btn-sm btn-primary">Edit</a>
                    <a href="{{ route('product.category.delete', $cat->product_id) }}" class="btn btn-sm btn-danger delete-confirmation" data-id="{{ $cat->id }}">Delete</a>
                </td>
            </tr>
        @endforeach
    </tbody>
