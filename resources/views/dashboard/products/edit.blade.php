        ...
        <div class="mb-3">
            ...
            <select class="form-control" name="product_id">
                ...
                @foreach ($categories as $category)
                    <option value="{{ $product->product_id }}" {{ (old('product_id') ?? $category->product_id) == $category->product_id ? 'selected' : '' }}>
                        {{ $category->name }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <img src="{{ asset($product->picture2) }}" alt="Product Picture 2" width="100" height="100"
                    style="border-radius: 50%" />
                <img src="{{ asset($product->picture3) }}" alt="Product Picture 3" width="100" height="100"
                    style="border-radius: 50%" />
            </div>
